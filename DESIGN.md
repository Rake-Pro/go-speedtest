...
terminal. No librespeed wire compatibility — the API is native and defined here.
...
## Measurement methodology (librespeed-derived, final)
...
## API surface (native, no librespeed compat)
